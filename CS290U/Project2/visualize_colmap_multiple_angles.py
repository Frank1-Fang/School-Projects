...
def visualize_colmap_model_multi(sparse_dir, output_dir):
    """绘制点云与相机位置，多视角保存"""
    ...
    # 四个指定视角
    views = [(25, 45), (25, 135), (25, 225), (25, 315)]
    ...
    for elev, azim in views:
        ...
        ax.set_box_aspect([1, 1, 1.5])  # 适度立体感

        # 保存
        output_path = os.path.join(output_dir, f"sparse_model_nature_a{azim}.png")
        plt.tight_layout()
...
if __name__ == "__main__":
    sparse_dir = "colmap_models/sparse/0"
    output_dir = "output/colmap"
    visualize_colmap_model_multi(sparse_dir, output_dir)
